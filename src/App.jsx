...
const Card = ({ icon: Icon, title, text, highlight }) => (
    <div className="card-hover bg-zinc-950 border border-zinc-800 p-6 rounded-none hover:border-red-500/20">
        <div className="flex items-center gap-4 mb-4">
            <div className="bg-red-500/10 p-3 rounded-none text-red-500">
                <Icon size={22} />
            </div>
            <h4 className="text-[15px] font-semibold text-white tracking-tight">{title}</h4>
        </div>
        <p className="text-zinc-400 text-[14px] leading-relaxed">{text}</p>
        {highlight && <div className="mt-4 text-[13px] font-semibold text-red-400 tracking-wider">{highlight}</div>}
    </div>
);
...
export default function App() {
    ...
    return (
        <div ref={containerRef} className="bg-black text-zinc-300 min-h-screen overflow-hidden scroll-smooth relative">
            ...
            {/* --- HERO SECTION --- */}
            <section className="snap-section min-h-screen hero-section relative min-h-screen flex flex-col justify-center items-center text-center px-4 py-20 overflow-hidden">
            ...
            {/* --- CHAPTER 1: INTRO --- */}
            <section className="snap-section min-h-screen animate-on-scroll opacity-0 translate-y-12 transition-all duration-1000 ease-out py-24 md:py-32 px-6 lg:px-12 max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                    <div>
                        ...
                        <p className="text-[18px] leading-relaxed mb-8 text-zinc-400 font-normal">
                        ...
                        <ul className="space-y-3 text-zinc-400 text-[14px]">
            ...
            <section className="snap-section min-h-screen animate-on-scroll opacity-0 translate-y-12 transition-all duration-1000 ease-out py-24 md:py-32 px-6 lg:px-12 bg-black border-y border-zinc-800">
                <div className="max-w-7xl mx-auto">
                    <SectionHeading subtitle="Chapter 2: Planning" title="Strategic intelligence" />

                    <p className="text-[18px] max-w-4xl mb-16 text-zinc-400 font-normal">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
                        <div>
                            ...
                            <div className="w-full overflow-x-auto">
                              <table className="min-w-[600px] w-full text-left text-[14px] border-collapse bg-black border border-zinc-800 rounded-none">
                                <thead>
                                    <tr>
                                        <th className="p-4 border-b border-zinc-800">Strategy</th>
                                        <th className="p-4 border-b border-zinc-800">Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                  <tr>
                                      <td className="p-4 border-b border-zinc-800 border-l-[3px] border-l-emerald-500 font-medium text-white">SO: Maxi-Maxi (Leveraging strengths)</td>
                                      <td className="p-4 border-b border-zinc-800 text-zinc-400">Monetize the sustained weak Yen by aggressively scaling exports of high-margin Camry and RAV4 hybrids from Japanese plants. Simultaneously, lead government-subsidized electrification initiatives globally by utilizing existing massive operational scale and long-standing political goodwill in key markets like the US and EU.</td>
                                  </tr>
                                  <tr>
                                      <td className="p-4 border-b border-zinc-800 border-l-[3px] border-l-orange-500 font-medium text-white">WO: Mini-Maxi (Overcoming weaknesses)</td>
                                      <td className="p-4 border-b border-zinc-800 text-zinc-400">Systematically tap into lucrative government green incentives (like the US Inflation Reduction Act) to aggressively fund and de-risk the massive $13.9B North Carolina battery manufacturing plant. This strategic capital injection directly closes the critical battery-electric vehicle (BEV) technological lag that Toyota currently faces against Tesla and BYD.</td>
                                  </tr>
                                  <tr>
                                      <td className="p-4 border-l-[3px] border-l-red-500 font-medium text-white">WT: Mini-Mini (Defensive posturing)</td>
                                      <td className="p-4 text-zinc-400">Aggressively preempt shifting trade wars by reducing corporate break-even volumes. Under CEO Kenta Kon, Toyota is restructuring domestic operations to withstand tariff-driven margin compression by enforcing extreme lean manufacturing efficiencies and cutting out non-essential software bloat before regulatory hammers drop.</td>
                                  </tr>
                                </tbody>
                              </table>
                            </div>
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-2 gap-4 h-full">
                                <div className="bg-black p-4 rounded-none border border-zinc-800 text-[14px]">
                    ...
                    <div className="mb-20">
                        ...
                        <div className="flex flex-col md:flex-row gap-8">
                            ...
                            <div className="md:w-3/4 flex flex-col items-center">
                                <div className="text-zinc-400 text-[14px] font-medium mb-4">Market share</div>
                                <div className="grid grid-cols-2 gap-2 w-full max-w-2xl relative">
                                    
                                    {/* Y axis label - No writing mode */}
                                    <div className="absolute -left-12 top-1/2 -mt-6 text-zinc-400 text-[14px] font-medium rotate-[-90deg] hidden md:block">
                                        Market growth
                                    </div>
                                    
                                    {/* Star */}
                                    <div className="card-hover bg-zinc-900 border border-zinc-800 p-6 rounded-none min-h-[160px]">
                                        <h4 className="text-[15px] font-semibold text-zinc-100 mb-2 tracking-tight">Stars</h4>
                                        <p className="text-[14px] text-zinc-300 font-medium mb-1">HEV (Hybrids) & RAV4/Camry</p>
                                        <p className="text-[14px] text-zinc-400">High share, high growth. These models are absolute juggernauts. They represent the current primary revenue drivers, brilliantly capturing the transitional consumer demographic that wants electrification without range anxiety.</p>
                                    </div>
                                    
                                    {/* Question Mark */}
                                    <div className="card-hover bg-zinc-900 border border-zinc-800 p-6 rounded-none min-h-[160px]">
                                        <h4 className="text-[15px] font-semibold text-zinc-300 mb-2 tracking-tight">Question marks</h4>
                                        <p className="text-[14px] text-zinc-300 font-medium mb-1">BEV (bZ4X) & Hydrogen (Mirai)</p>
                                        <p className="text-[14px] text-zinc-400">Low share, high growth. These products require disproportionate, massive R&D capital injections to secure a long-term market footing against established EV rivals, yet return little to no immediate profit.</p>
                                    </div>

                                    {/* Cash Cow */}
                                    <div className="card-hover bg-zinc-900 border border-zinc-800 p-6 rounded-none min-h-[160px]">
                                        <h4 className="text-[15px] font-semibold text-emerald-400 mb-2 tracking-tight">Cash cows</h4>
                                        <p className="text-[14px] text-zinc-300 font-medium mb-1">ICE Trucks & SUVs (Tacoma/Hilux)</p>
                                        <p className="text-[14px] text-zinc-400">High share, low growth. These are the highly profitable, depreciated-tooling legacy stalwarts. They generate immense free cash flow, acting as the primary fiscal engine funding the futuristic BEV and Hydrogen bets.</p>
                                    </div>

                                    {/* Dog */}
                                    <div className="card-hover bg-zinc-900 border border-zinc-800 p-6 rounded-none min-h-[160px]">
                                        <h4 className="text-[15px] font-semibold text-zinc-300 mb-2 tracking-tight">Dogs</h4>
                                        <p className="text-[14px] text-zinc-300 font-medium mb-1">Compact & Midsize ICE Sedans</p>
                                        <p className="text-[14px] text-zinc-400">Low share, low growth limit. With global consumer preferences decisively shifting towards larger SUVs and CUVs, Toyota is actively consolidating and divesting from non-hybrid traditional sedan segments to prevent capital drain.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 stagger">
                            <div className="card-hover bg-zinc-950 border-t-[3px] border-red-600 p-5 rounded-none flex flex-col justify-between">
                                <div>
                                    ...
                                    <p className="text-[14px] text-zinc-400 mt-2 font-normal">Toyota is engaged in direct, brutal confrontation on multiple fronts: legacy giants like VW and Hyundai pushing heavy volume, and heavily subsidized, aggressive Chinese EV OEMs (BYD, SAIC) triggering severe global margin compression and price wars.</p>
                                </div>
                            </div>
                            <div className="card-hover bg-zinc-950 border-t-[3px] border-orange-500 p-5 rounded-none flex flex-col justify-between">
                                <div>
                            ...
                            <div className="card-hover bg-zinc-950 border-t-[3px] border-orange-500 p-5 rounded-none flex flex-col justify-between">
                                <div>
                                    ...
                                    <span className="text-[14px] font-medium text-orange-400 tracking-wider">Mod-high</span>
                                    <p className="text-[14px] text-zinc-400 mt-2 font-normal">Automakers face extreme reliance on heavily concentrated global supply chains for rare-earth battery minerals and advanced semiconductor chips. Toyota aggressively counters this extortion leverage via massive vertical integration, notably its in-house $13.9B NC battery campus.</p>
                                </div>
                            </div>
                            <div className="card-hover bg-zinc-950 border-t-[3px] border-yellow-500 p-5 rounded-none flex flex-col justify-between">
                                <div>
                                    ...
                                    <p className="text-[14px] text-zinc-400 mt-2 font-normal">Historically, manufacturing required massive capital barriers. Now, well-funded software-first technology firms (like Tesla originally, or emerging tech-auto joint ventures) are bypassing legacy engine manufacturing entirely, supported directly by foreign government EV subsidies.</p>
                                </div>
                            </div>
                            <div className="card-hover bg-zinc-950 border-t-[3px] border-yellow-500 p-5 rounded-none lg:col-span-2 flex flex-col justify-between">
                                <div>
                                    <h5 className="font-semibold text-white mb-1 tracking-tight">Substitutes</h5>
                                    <span className="text-[14px] font-medium text-yellow-500 tracking-wider">Moderate</span>
                                    <p className="text-[14px] text-zinc-400 mt-2 font-normal">The rise of ubiquitous urban mobility platforms (Uber, DiDi, Lyft), advanced high-speed rail, and micro-mobility solutions fundamentally threaten the private ownership model. Toyota's strategic pivot into a broad "mobility provider" deliberately hedges against this post-ownership future.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="snap-section min-h-screen animate-on-scroll opacity-0 translate-y-12 transition-all duration-1000 ease-out py-24 md:py-32 px-6 lg:px-12 max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                    <div>
                        <p className="text-[18px] text-zinc-400 mb-6 leading-relaxed font-normal">
                        ...
                        <p className="text-[18px] text-zinc-400 mb-10 leading-relaxed font-normal">
                    ...
                    <div className="flex flex-col gap-8">
                        {/* Governance Board */}
                        <div className="card-hover bg-zinc-950 p-8 rounded-none border border-zinc-800">
                            <h4 className="text-[17px] font-semibold text-white mb-4 flex items-center gap-3 tracking-tight"><Scale className="text-red-500" /> Board governance evolution</h4>
                            <p className="text-zinc-400 text-[14px] mb-4 font-normal">
                        ...
                        <div className="bg-red-600 p-8 rounded-none text-white shadow-2xl">
            ...
            {/* --- CHAPTER 4: STAFFING --- */}
            <section className="snap-section min-h-screen animate-on-scroll opacity-0 translate-y-12 transition-all duration-1000 ease-out py-24 md:py-32 px-6 lg:px-12 bg-zinc-950 border-y border-zinc-800">
                <div className="max-w-7xl mx-auto">
                    <SectionHeading subtitle="Chapter 4: Staffing" title="The human capital asset" />

                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
                        <div className="lg:col-span-2">
                            <p className="text-[18px] text-zinc-300 mb-6 leading-relaxed font-normal">
                            ...
                            <p className="text-[18px] text-zinc-400 mb-8 leading-relaxed font-normal">
                        ...
                        <div className="bg-black border border-zinc-800 p-8 shadow-xl relative overflow-hidden">
                            ...
                            <p className="text-[14px] text-zinc-400 mb-6 relative z-10">Annual evaluations deliberately bypass highly subjective personality traits, focusing intensely instead on 5 primary, rigorously empirical criteria (worth 10 points each):</p>

                            <ul className="space-y-4 relative z-10 text-[14px]">
                                <li className="bg-zinc-950 p-3 border border-zinc-800 border-l-[3px] border-l-red-500">
                                    <strong className="text-white block font-medium mb-1">1. Physical skills (takt time)</strong>
                                    <span className="text-zinc-400">The raw physical ability of the worker to handle complex assembly tasks strictly within the mathematically designated 'takt time' cycle, doing so without degrading overall product quality or safety.</span>
                                </li>
                                <li className="bg-zinc-950 p-3 border border-zinc-800 border-l-[3px] border-l-red-500">
                                ...
                                <li className="bg-zinc-950 p-3 border border-zinc-800 border-l-[3px] border-l-red-500">
                                    ...
                                    <span className="text-zinc-400">The cognitive ability of an operator to clearly articulate exactly how their microscopic daily assembly targets directly derive from and support the broader macro corporate objectives.</span>
                                </li>
                                <li className="bg-zinc-950 p-3 border border-zinc-800 border-l-[3px] border-l-red-500">
                                    <strong className="text-white block font-medium mb-1">5. Problem solving</strong>
                                    <span className="text-zinc-400">Proven intellectual capability to independently execute comprehensive root-cause analysis (utilizing the "5 Whys" methodology) and immediately physically deploy corrective countermeasures.</span>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            {/* --- CHAPTER 5: LEADING --- */}
            <section className="snap-section min-h-screen animate-on-scroll opacity-0 translate-y-12 transition-all duration-1000 ease-out py-24 md:py-32 px-6 lg:px-12 bg-red-600 text-white selection:bg-white selection:text-red-600">
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div>
                        ...
                        <div className="space-y-6 mt-10">
                            <div className="bg-black/20 p-6 rounded-none">
                    ...
                    <div className="bg-white text-slate-900 p-10 rounded-none shadow-2xl transform lg:rotate-2 hover:rotate-0 transition-transform duration-500">
                        ...
                        <div className="flex items-center gap-6 mb-8 border-b border-slate-200 pb-8">
                            ...
                            <div className="text-[14px] font-medium text-zinc-500 tracking-widest leading-tight">
            ...
            <section className="snap-section min-h-screen animate-on-scroll opacity-0 translate-y-12 transition-all duration-1000 ease-out py-24 md:py-32 px-6 lg:px-12 max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                    ...
                    <div className="col-span-1 lg:col-span-6">
                        ...
                        <p className="text-zinc-400 mb-8 leading-relaxed text-[16px] font-normal">
                        ...
                        <div className="space-y-8 bg-zinc-950 p-8 rounded-none border border-zinc-800">
                            {/* Chart Bar 1 */}
                            <div>
                                ...
                                <div className="h-8 bg-zinc-900 rounded-none overflow-hidden relative">
                                    <div className="absolute top-0 left-0 h-full bg-blue-600 w-[95%] rounded-none"></div>
                            ...
                            <div>
                                ...
                                <div className="h-8 bg-zinc-900 rounded-none overflow-hidden relative">
                                    <div className="absolute top-0 left-0 h-full bg-emerald-600 w-[85%] rounded-none"></div>
                            ...
                            <div>
                                ...
                                <div className="h-8 bg-zinc-900 rounded-none overflow-hidden relative">
                                    <div className="absolute top-0 left-0 h-full bg-orange-600 w-[71%] rounded-none"></div>
                            ...
                            <div>
                                ...
                                <div className="h-8 bg-zinc-900 rounded-none overflow-hidden relative">
                                    <div className="absolute top-0 left-0 h-full bg-yellow-600 w-[80%] rounded-none"></div>
                    ...
                    <div className="col-span-1 lg:col-span-6 flex flex-col gap-6">
                        <div className="card-hover bg-zinc-950 border border-zinc-800 rounded-none p-8">
                            <h3 className="text-[16px] font-semibold text-white mb-6 flex items-center gap-3 tracking-tight">
                                <ShieldCheck className="text-red-500" /> Executive compliance architecture
                            </h3>
                            <p className="text-[14px] text-zinc-400 mb-6 font-normal">
                            ...
                            <div className="relative border-l-[3px] border-zinc-800 pl-6 space-y-6">
                                <div className="relative">
                                    <div className="absolute w-3 h-3 bg-red-600 rounded-none -left-[32px] top-1.5"></div>
                                    <h5 className="text-[16px] font-medium text-white mb-1">Global chief compliance officer (GCCO)</h5>
                                    <p className="text-[14px] text-zinc-400 font-normal">A newly established centralized role that wields unmitigated, absolute veto authority over factory line compliance issues. The GCCO directly chairs the critical Compliance Committee alongside the Risk Management board to ensure regulatory deviations are reported directly to the CEO, entirely bypassing middle management coverups.</p>
                                </div>
                                <div className="relative">
                                    <div className="absolute w-3 h-3 bg-slate-600 rounded-none -left-[32px] top-1.5"></div>
                                    <h5 className="text-[16px] font-medium text-white mb-1">Regional CCO delegates</h5>
                                    <p className="text-[14px] text-zinc-400 font-normal">Strategically appointed across heavily regulated territories like North America and the EU to ensure specific, localized cultural management nuances do not obscure or contradict high-level Japanese corporate governance mandates.</p>
                                </div>
                            </div>
                        </div>
            ...
            <footer className="animate-on-scroll opacity-0 translate-y-12 transition-all duration-1000 ease-out bg-black py-20 border-t-4 border-red-600 text-center px-4">
                <div className="max-w-4xl mx-auto">
                    ...
                    <p className="text-[18px] text-zinc-400 font-normal leading-relaxed mb-12">
